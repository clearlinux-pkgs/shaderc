...
Source0  : https://github.com/google/shaderc/archive/v2024.2/shaderc-2024.2.tar.gz
...
cd %{_builddir}/shaderc-2024.2
mkdir -p third_party/spirv-tools
cp -r %{_builddir}/SPIRV-Tools-vulkan-sdk-1.3.275.0/* %{_builddir}/shaderc-2024.2/third_party/spirv-tools
mkdir -p third_party/spirv-headers
cp -r %{_builddir}/SPIRV-Headers-sdk-1.3.261.0/* %{_builddir}/shaderc-2024.2/third_party/spirv-headers
mkdir -p third_party/glslang
cp -r %{_builddir}/glslang-14.1.0/* %{_builddir}/shaderc-2024.2/third_party/glslang
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726090594
mkdir -p clr-build
pushd clr-build
