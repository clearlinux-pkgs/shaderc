...
Source2  : https://github.com/KhronosGroup/SPIRV-Tools/archive/vulkan-sdk-1.3.290.0/SPIRV-Tools-1.3.290.0.tar.gz
...
cd %{_builddir}
tar xf %{_sourcedir}/SPIRV-Tools-1.3.290.0.tar.gz
cd %{_builddir}
tar xf %{_sourcedir}/SPIRV-Headers-1.3.290.0.tar.gz
cd %{_builddir}
tar xf %{_sourcedir}/glslang-15.0.0.tar.gz
cd %{_builddir}/shaderc-2024.3
mkdir -p third_party/spirv-tools
cp -r %{_builddir}/SPIRV-Tools-vulkan-sdk-1.3.290.0/* %{_builddir}/shaderc-2024.3/third_party/spirv-tools
mkdir -p third_party/spirv-headers
cp -r %{_builddir}/SPIRV-Headers-vulkan-sdk-1.3.290.0/* %{_builddir}/shaderc-2024.3/third_party/spirv-headers
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727804121
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/SPIRV-Headers-vulkan-sdk-1.3.290.0/LICENSE %{buildroot}/usr/share/package-licenses/shaderc/438253baaf6fa525f43a0afff2da8be3d7442b75 || :
cp %{_builddir}/SPIRV-Tools-vulkan-sdk-1.3.290.0/LICENSE %{buildroot}/usr/share/package-licenses/shaderc/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/SPIRV-Tools-vulkan-sdk-1.3.290.0/utils/vscode/src/lsp/LICENSE %{buildroot}/usr/share/package-licenses/shaderc/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
...
rm -f %{buildroot}*/usr/bin/glslang
...
/usr/share/package-licenses/shaderc/438253baaf6fa525f43a0afff2da8be3d7442b75
